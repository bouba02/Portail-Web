...
// *****************************************Images upload code end here********************************************************** 
 		...
 		$query="INSERT INTO `student`( `nom`, `prenoms`, `dateNaissance`, `email`, `telephone`, `password`, `photo`, `adresse`, `ville`, `semestre`, `admission`, `cni`,`sexe`) VALUES ('$first_name','$last_name','$dob','$email','$mobile_no','$password','$profile_image','$permanent_address','$ville',$semestre,'$admission','$cnic','$sexe')";
...
<html lang="en">
	<head>
		<title>Admin - Gestion Etudiant</title>
	</head>
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-3 text-white admin-dashboard pl-3">
					<div class="d-flex">
						<h4 class="mr-5">Gestionnaire des Étudiants</h4>
						<!-- <button type="button" class="btn btn-primary ml-5" data-toggle="modal" data-target=".bd-example-modal-lg">Ajouter un étudiant</button> -->
					</div>
				</div>
							...
							<div class="row">
								<div class="col-md-6">
									<form action="search_student.php" method="post">
										<div class="form-group">
											<label for="exampleInputPassword1"><h5>Recherchez un Etudiant:</h5></label>
											<div class="d-flex">
												<input type="text" name="search" id="search" class="form form-control" placeholder="Entrez l'email">
								...
								<div class="col-md-12 pt-5 mb-2">
									...
									<!-- <div class="modal fade bd-example-modal-lg1" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
										<div class="modal-dialog modal-lg">
												<div class="modal-content">
													<div class="modal-header bg-info text-white">
														<h4 class="modal-title text-center">Attribuer un Semestre à un Etudiant</h4>
													</div>
													<div class="modal-body">
														<form action="student.php" method="POST" enctype="multipart/form-data">
															<div class="row mt-3">
							...
							<table class="w-100 table-elements mb-5 table-three-tr text-center" cellpadding="10">
								...
								while($row=mysqli_fetch_array($run)) {?>
									<tr>
										...
										<td><?php  $profile_image= $row["photo"]; ?> 
										<img height='50px' width='50px' src=<?php echo "./images/$profile_image"  ?> >
										</td>
										<td width='170'> 
											<?php 
												echo "<a class='btn btn-primary' href=display-student.php?roll_no=".$row['code'].">Profile</a> 
