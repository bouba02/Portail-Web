							...
							<div class="row mt-3">
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="text" name="course_code" class="form-control" required placeholder="Entrez le code Filière">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputPassword1">Nom Filière:</label>
										<input type="text" name="course_name" class="form-control" required placeholder="Entrez Nom de Filière">
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">Semestre ou Année:</label>
										<input type="text" name="semester_or_year" class="form-control" required placeholder="Semestre ou Année">
									</div>
								</div>
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputPassword1">Nombre d'année:</label>
										<input type="text" name="no_of_year" class="form-control" required  placeholder="Entrez Nombre d'année">
									</div>
								</div>
							</div>
							<div class="row w-100">
