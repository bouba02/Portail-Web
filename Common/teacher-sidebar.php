			...
			<div class="col-xl-2 col-lg-3 col-md-4 sidebar position-fixed border-right">
				...
				<ul class="nav flex-column">
					...
					<li class="nav-item">
						...
						<span data-feather="file"></span>
						<i class="fa fa-info-circle mr-2" aria-hidden="true"></i> Information Personnelle
						</a>
						</li>
					<li class="nav-item">
						<a class="nav-link" href="../teacher/display_Etudiant.php">
						<span data-feather="shopping-cart"></span>
						<i class="fa fa-address-book mr-2" aria-hidden="true"></i> Liste des Etudiants
						</a>
					</li>
					<!-- <li class="nav-item">
					...
					<li class="nav-item">
						...
						<span data-feather="users"></span>
						<i class="fa fa-users mr-2" aria-hidden="true"></i> Note Etudiant
						</a>
					</li>
					<li class="nav-item">
