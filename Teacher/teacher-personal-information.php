...
<?php 
	...
	if (isset($_POST['sub'])) {
		...
		$query="update teacher_info set first_name='$first_name',last_name='$last_name',cnic='$cnic',phone_no='$phone_no',gender='$gender',permanent_address='$permanent_address',place_of_birth='$place_of_birth',state='$state' where teacher_id='$teacher_id'";
...
<html lang="en">
	<head>
		<title>Information Personnel du Professeur</title>
	</head>
	<body>
		...
		<main role="main" class="col-xl-10 col-lg-9 col-md-8 ml-sm-auto px-md-4 main-background mb-2 w-100">
			<div class="sub-main">
				<div class="text-center d-flex flex-wrap flex-md-nowrap pt-3 pb-2 mb-4 text-white admin-dashboard pl-3">
					<h4 class="">Modifier vos Informations Personnelles</h4>
				</div>
				<div class="row">
					<div class="col-lg-12 col-md-12">
						<form action="teacher-personal-information.php" method="post">
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										<label for="exampleInputEmail1">Ville ou Provence: *</label>
						...
						<?php } ?>
							<div class="row">
								<div class="col-md-4 offset-5 mt-3">
									<button type="submit" name="sub" class="btn btn-primary">Modifier les informations</button>
								</div>
							</div>
						</form>
					</div>
