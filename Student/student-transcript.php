...
<?php
    function grade($obtain_marks, $assign_date) {
        ...
        if($assign_date <=15){
            ...
            else if ($obtain_marks>=16) {
                $grade = "Bien";
            }
            else if ($obtain_marks>=12) {
                $grade = "Assez Bien";
            }
...
?>
    ...
    <title> Relevé de notes de l'étudiant</title>

<?php include "../common/common-header.php"?>
    <div class="container mt-4">
        <div class="text-danger text-center m-auto">
            <img src="../Images/logoFSR.png" alt="" width="100" height="100">
            <h4 class="text-dark mt-3">FACULTE DES SCIENCES DE RABAT - FSR*</h4>
    ...
    <div class="container-fluid mb-4 text-dark">
        <div class="program-info">
            <?php  
                ...
                // $query = "select * from student inner join sessions on sessions.session=student.session where code = '$roll_no'";
                $query = "select * from student  where code = '$roll_no'";

                $run = mysqli_query($con, $query);
                while($row = mysqli_fetch_array($run)){ ?>
                    <h5>Relevé de notes - Semestre <?php echo $row['semestre']; ?> </h5>
        </div>
        <div class="d-flex mt-3">
            <div>
                <h5>Nom & Prenoms  : <?php echo $row['nom']. " ". $row['prenoms']; ?></h5>
                <!-- <h5>S/O : <?php echo $row['father_name']; ?></h5> -->
            </div>
            <div class="ml-auto">
                <h5>Code Etudiant # : <?php echo $row['code']; ?></h5>
                <h5>Année D'Admission : <?php echo intval($row['admission_date']); ?></h5>
            </div>
        </div>
        <?php }
        ?>
